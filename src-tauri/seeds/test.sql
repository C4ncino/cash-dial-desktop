...
VALUES
-- Salary
(1, 1, 1, NULL, 1, 1, 3500.00, 3500.00, NULL, 1751328000, 'Monthly salary'),

-- Grocery shopping
(2, 2, 1, NULL, 2, 1, 85.42, 85.42, NULL, 1751414400, 'Supermarket'),

-- Netflix yearly subscription (12 installments)
(3, 2, 3, NULL, 3, 1, 120.00, 120.00, 12, 1751500800, 'Netflix annual plan'),

-- Transfer from checking to savings
(4, 3, 1, 2, 4, 1, 500.00, 500.00, NULL, 1751587200, 'Monthly savings'),

-- Electric bill
(5, 2, 1, NULL, 5, 1, 64.75, 64.75, NULL, 1751673600, 'Electricity bill'),

-- New laptop (6 installments)
(6, 2, 3, NULL, 3, 1, 1800.00, 1800.00, 6, 1751760000, 'Laptop purchase');
